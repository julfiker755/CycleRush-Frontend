    ...
    >
      ...
      <div className="flex items-center h-14 border-b relative ">
        ...
        <Button
          ...
          className={`absolute   h-8 w-8 p-0 ${
            collapsed ? "-top-7 left-1/2 -translate-x-1/2" : "top-3 right-1"
          }`}
        >
      ...
      <div className="flex-1 overflow-y-auto py-2">
        <nav className="space-y-0.5 px-2">
          ...
          <div
            ...
            className={`flex items-center text-primary cursor-pointer rounded-md text-sm h-10 hover:bg-muted  ${
              collapsed
                ? "justify-center px-3.5 w-max"
                : "justify-start px-3 w-full"
            }`}
